...
export default function LifeOfMingas() {
  ...
  useEffect(() => {
    ...
    gsap
      ...
      .to(divs[3], { y: -1140, x: 100, opacity: 1 }, 'four')
      ...
      .to(divs[4], { y: -1600, x: 100, opacity: 1 }, 'five')
      ...
      .to(divs[6], { y: -2600, x: 0, opacity: 0.05 }, 'eight')
      ...
      .to(divs[7], { y: -3000, x: 0, opacity: 0.05 }, 'nine')
      .to(divs[8], { y: -3200, x: 100, opacity: 1 }, 'nine')
      ...
      .to(divs[11], { y: -4500, x: 100, opacity: 1 }, 'twelve')
  ...
  const mediumFunction =
    (() => {
      ...
      gsap
        ...
        .add('one')
        .to(divs[0], { y: 500, x: 100, opacity: 1 }, 'one')
        .to(divs[1], { y: 500, x: 0, opacity: 0.05 }, 'one')
        .to(divs[2], { y: -300, x: 0, opacity: 0.05 }, 'one')
        .to(divs[3], { y: -200, x: 0, opacity: 0.05 }, 'one');
    ...
    []);
  medium ? console.log('media') : console.log('no');
  return (
    <>
