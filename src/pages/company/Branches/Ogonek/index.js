  ...
  return (
    <div>
      ...
      <BlockInformOgonek id={'4'}>
        <div>
          ...
          <p>
            ...
            трехсекционный двухэтажный корпус, включающий в себя: 22 номера комфорт класса со всеми
            удобствами и 4 номера класса люкс, конференц зал, роскошный обеденный и банкетный зал на
            90 человек, кино-зал, игровую комнату и комнату отдыха, кафетерий, сауну с бассейном,
            тренажерный зал, постирочную и сушильную комнаты, современный пищеблок.
          </p>
          <p>
          ...
          <p>
            ...
            WI-FI, холодильниками, чайниками. Игровая комната оборудована «Аэрохоккеем», настольным
            футболом, бильярдом, дартсом, настольным теннисом и другими настольными играми.
          </p>
        </div>
      ...
      <div>
        ...
        <p>
          Директор: Шаматульский Виталий Леонидович
          <p>
