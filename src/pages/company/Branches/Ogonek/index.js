...
import background from '../../../../assets/Ogonek/5.JPG';
import { Name } from '../../../../components/administrativeServices/Header/styles';
import TitleForHome from '../../../../components/TitleForHome';
import { ContainerFunctionService } from '../../../services/DopFunction/styles';
          ...
          <>
            ...
            <BlockInformOgonek id={'2'}>
              <div>
                ...
                <p>
                  В детском лагере организовано пятиразовое сбалансированное, с учетом
                  физиологических потребностей в энергии и пищевых веществах для детей всех
                  возрастных групп и рекомендуемых суточных наборов пищевых продуктов для
                ...
                <p>
                  ...
                  Включает в себя завтрак, обед, полдник, ужин, второй ужин. Вкусная и полезная
                  кухня – важный элемент оздоровления!
                </p>
              </div>
            ...
            <BlockInformOgonek id={'4'}>
              <div>
                ...
                <p>
                  ...
                  банкетный зал на 90 человек, кино-зал, игровую комнату и комнату отдыха,
                  кафетерий, сауну с бассейном, тренажерный зал, постирочную и сушильную комнаты,
                  современный пищеблок.
                </p>
                <p>
            ...
            <ContainerFunctionService style={{ width: '100%', margin: '0 auto' }}>
              <Name>Как с нами связаться:</Name>
              <TitleForHome
              ...
              />
              <img
                style={{ transform: 'rotate(-90deg)', width: '50%', margin: '4% auto' }}
                alt={''}
                src={require('../../../../assets/management/departaments/Шаматульский.jpg')}
              />
