              ...
              <Table style={{ height: '70%', margin: 'auto 0' }}>
                <Tbody className={'general'}>
                  ...
                  <tr>
                    ...
                    <td>
                      г. Минск, ул. П. Бровки, д. 1 ежедневно с 8.00 до 20.00, кроме праздничных
                      дней <br />
                      г. Заславль, ул. Советская, 79 9.00-18.00 (пн-чт и 3-я суббота месяца),
                      9.00-16.45 (пт.), обед: 13.00-13.45
                    </td>
                  </tr>
                  <tr>
                    <td>«Горячая линия»</td>
                    <td>
                      <a href={'tel:+375(17)-299-28-70'}> +375(17)-299-28-70</a>, круглосуточно
                    </td>
                  </tr>
                  <tr>
                    <td>
