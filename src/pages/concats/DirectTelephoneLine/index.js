              ...
              <Table style={{ height: '70%', margin: 'auto 0' }}>
                <Tbody className={'general'}>
                  <tr>
                    ...
                    <td>
                      <a style={{ fontWeight: 'bold' }} href={'tel:162'}>
                        162
                      </a>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>График работы</td>
                    <td>
                      с 8.00 до 17.00 понедельник - четверг, пятница - с 8:00 до 15:45 <br /> приём граждан с 8.00 до 20.00,
                      кроме праздничных дней
                    </td>
                  </tr>
                  <tr>
                    <td>Приёмная руководителя</td>
                    <td>
