          ...
          >
            ...
            <TextForInformation>
              ...
              <p>
                ...
                15.12.2022 г. Предложение для переговоров представляется по адресу: 220037, г.Минск,
                ул.Ботаническая, 11/1, кабинет № 101 (канцелярия).
              </p>
              <p>
                Заседание конкурсной комиссии{' '}
                <strong style={{ color: 'red' }}>15.12.2022 г. в 13.00</strong> по адресу: г.Минск,
          ...
          >
            ...
            <TextForInformation>
              ...
              <p>
                ...
                выполнения проектных и изыскательских работ по объекту: «Вынос газопровода среднего
                давления Ду-159 из-под пятна застройки д.Петришки по ул.Земляничные Поляны»
              </p>
              <p>
              ...
              <p>
                Предложения для переговоров представляются участниками переговоров в срок до 11.00
                16.12.2022 г. Предложение для переговоров представляется по адресу: 220037, г.Минск,
                ул.Ботаническая, 11/1, кабинет № 101 (канцелярия).
              </p>
              <p>
                Заседание конкурсной комиссии{' '}
                <strong style={{ color: 'red' }}>16.12.2022 г. в 13.00</strong> по адресу: г.Минск,
                ул.Ботаническая, 11/1, конференц-зал.
              </p>
              <p>
                Организатор переговоров УП «МИНГАЗ». Р/с BY17AKBB30121087600145300000 в ЦБУ №514 ОАО
                «АСБ «Беларусбанк», БИК AKBBBY2Х, УНП 100308563, ОКПО 03000992. Е-mail:
                oks@mingas.by Ответственные исполнители (контактное лицо): Начальник ОЭСГиГ
                производственно-технического управления (ПТУ) – Жуковский Евгений Александрович,
                инженер 1-й категории управления капитального строительства (УКС) – Нестерович Ирина
                Сергеевна.
              </p>
              <p>Тел: (017)299-28-56, (017) 294-83-63; (017)299-29-21; факс: (017)294-83-63.</p>
            </TextForInformation>
          </ContainerInform>
          <Link>
            <a
