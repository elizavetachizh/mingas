    ...
    <ContainerContent
      ...
      content={
        <>
          ...
          {/*    </p>*/}
          {/*    <p>*/}
          {/*      Лот №1 «Реконструкция (перекладка) подземного распределительного газопровода*/}
          {/*      среднего давления в районе жилых домов №38, 40 по ул.Ратомской в г.Минске».*/}
          {/*    </p>*/}
          {/*    <p>*/}
          ...
          {/*      09.12.2022 г. Предложение для переговоров представляется по адресу: 220037, г.Минск,*/}
          {/*      ул.Ботаническая, 11/1, кабинет № 101 (Канцелярия).*/}
          {/*    </p>*/}
          {/*    <p>*/}
          {/*      Заседание конкурсной комиссии{' '}*/}
          {/*      <strong style={{ color: 'red' }}>09.12.2022 г. в 13.00</strong> по адресу: г.Минск,*/}
