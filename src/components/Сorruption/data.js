...
export const data = [
  ...
  {
    id: 4,
    name: 'Памятка об ответственности ',
    link: pamyatka,
  },
  {
    id: 5,
    name: 'Карта коррупционных рисков',
    link: carta_corruption_risk,
  },
  {
    id: 6,
  ...
  {
    id: 7,
    name: 'Рекомендации для работников организаций, входящих в систему Министерства энергетики, по противодействию фактам провокаций получения взятки',
    link: recomendation,
  },
  {
    id: 8,
    name: 'Мероприятия по борьбе с преступностью и коррупцией Министерства энергетики на 2022-2024 годы',
    link: meroprtiatia,
  },
  {
    id: 9,
    name: 'Положение о конфликте интересов',
    link: polojenie_conflict,
  },
];
