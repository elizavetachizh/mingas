    ...
    <ContainerTable>
      <Table className={'firstColumn'}>
        ...
        <Tbody className={'firstColumn'}>
          ...
          <tr>
            <td>
                Калачик Михаил Игоревич
              <br />
              <p>Директор филиала ОК "Огонек"</p>
            </td>
          </tr>
          <tr>
            <td>
              <NavLink to={'/company/management/division/2'}> Семак Павел Александрович</NavLink>
              <br />
              <p>
        ...
        <Tbody>
          <tr>
            <td>
              ...
              <p style={{ color: 'red' }}>
               16.08.2023 личный прием проведет первый заместитель генерального директора Вирочкин Андрей Анатольевич
              </p>
              <br />
          ...
          <tr>
            ...
            <td>
              <p>Предварительная запись на прием осуществляется по тел.299 28 90</p>
              <p>понедельник-четверг: с 8.00 до 17.00,</p> <p>пятница: с 08.00 до 15.45</p>
              <p>обеденный перерыв с 12.00 до 12.45</p>
            </td>
          </tr>
          ...
          <tr>
            <td>
              ...
              <br /> <p>каб. 235 г. Минск, ул. Ботаническая 11/1</p>
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <p>Предварительная запись на прием осуществляется по тел.299 29 13</p>
              <p>понедельник-четверг: с 8.00 до 17.00,</p> <p>пятница: с 08.00 до 15.45</p>
              <p>обеденный перерыв с 12.00 до 12.45</p>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <p>Предварительная запись на прием осуществляется по тел.8 017 13 42 751</p>
              <p>Понедельник-пятница: с 8.00 до 17.00, обеденный перерыв с 12.00 до 13.00</p>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <p>Предварительная запись на прием осуществляется по тел. 8 044 539 93 99</p>
              <p>
